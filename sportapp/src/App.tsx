...
function App() {
  ...
  const [voteIndoor, setVoteState1] = useState("Vote");
  const [voteOutdoor, setVoteState2] = useState("Vote");
  const [CountIndoor, setCount1] = useState(0);
  const [CountOutdoor, setCount2] = useState(0);
  ...
  const app_address: number = 660149124;
  // CHANGE THIS TO YOUR APP ID
  ...
  useEffect(() => {
    ...
    getCount();
    setVoteState1("Vote");import { useState, useEffect } from "react";
    import algosdk from "algosdk";
    import { Buffer } from "buffer";
    import { PeraWalletConnect } from "@perawallet/connect";
    ...
    function App() {
      ...
      // CHANGE THIS TO YOUR APP ID
      const app_address: number = 659884635;
      // CHANGE THIS TO YOUR APP ID
      ...
      return (
        <div className="mainContainer">
          <div className="dataContainer">
            <div className="header">⚽What kind of sports do you like?</div>
            <div className="bio">
              Vote for your favourite sports types. Ensure your wallet is set to the{" "}
              <b>testnet</b>.
            </div>
                  ...
                  <>
                    <div className="sports-container">
                      <div className="sport-card">
                        ...
                        <div className="count">{CountIndoor}</div>
                        <button className="voteButton" onClick={addC1}>
                          {voteIndoor}
                        </button>
                      </div>
                      <div className="movie-card">
                        <div className="title">Outdoor</div>
                        <div className="count">{CountOutdoor}</div>
                        <button className="voteButton" onClick={addC2}>
                          {voteOutdoor}
                        </button>
                      </div>
                    </div>
